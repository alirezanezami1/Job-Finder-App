...
<template>
  <nav class="fixed bottom-0 w-full bg-white border-t border-gray-200">
    <div class="flex justify-around items-center p-2">
      <RouterLink to="/" class="flex flex-col items-center text-gray-600 hover:text-primary500">
        <HomeIcon class="w-6 h-6" />
        <span class="text-xs mt-1">خانه</span>
      </RouterLink>
      <RouterLink
        to="/bookmarks"
        class="flex flex-col items-center text-gray-600 hover:text-primary500"
      >
